"""
Cipher Range Bot v1.0 — Ranging Market Companion Bot
...
def check_range_entry(price, range_info, candle_list_1h):
    """
    Determines entry signal within a confirmed range.

    LONG:  price in bottom ENTRY_ZONE_PCT of range + RSI < 45
    SHORT: price in top ENTRY_ZONE_PCT of range + RSI > 55
    """
    ...
    long_signal  = in_long_zone  and rsi_long_ok
    short_signal = in_short_zone and rsi_short_ok
...
def main():
    global tick_count
    log.info("=" * 60)
    log.info("Cipher Range Bot v1.0 — Ranging Market Companion")
    ...
    while True:
        try:
            ...
            if (price
                ...
                entry_signal, entry_ind = check_range_entry(price, range_info, list(candles_1h))
